...
#### Установка данного форка ни коем разе не скажется на работоспособности раннее настроенных автоматизаций на базе VK Notify от uDocs, только добавит весь так недостающий функционал.
